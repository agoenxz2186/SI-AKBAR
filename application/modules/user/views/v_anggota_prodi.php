    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Anggota Prodi</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Data Anggota Prodi</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <h4>
                                                <center> <a href="#" data-toggle="modal" data-backdrop="false"
                                                        data-target="#verifikasi<?= $row->id ?>"
                                                        class="mr-1 mb-1 btn btn-outline-danger btn-min-width"><i
        ...
        <div class="modal fade text-left" id="status<?= $row->id ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url() . 'user/AnggotaProdi/update_status' ?>" method="post">
        ...
        <div class="modal fade text-left" id="delete<?php echo $row->id; ?>" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo base_url() . 'user/AnggotaProdi/hapus_anggota' ?>" method="post">
                        <div class="modal-body">
                            <div class="col-md-12 m-b-20">
...
<div class="col-lg-4 col-md-6 col-sm-12">
    <div class="form-group">
        ...
        <div class="modal fade text-left" id="verifikasi<?= $row->id ?>" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel11" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-info white">
