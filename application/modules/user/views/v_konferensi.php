    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Data Konferensi</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <a href="<?= base_url() ?>user/Konferensi/add_artikel" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Tambah Data</a>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Data Konferensi</h4>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td style="text-align:center;"><a href="<?= base_url() ?>user/Konferensi/edit_artikel/<?php echo $row->id_artikel; ?>" class="btn btn-outline-success">
            ...
            <div class="modal fade text-left" id="delete<?= $row->id_artikel ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'user/Konferensi/hapus_artikel' ?>" method="post">
