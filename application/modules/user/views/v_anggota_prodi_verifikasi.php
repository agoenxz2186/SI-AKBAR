    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Verifikasi Anggota Prodi</h4>
            </div>
            <div class="col-md-7 align-self-center text-right">
                <div class="d-flex justify-content-end align-items-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Data Anggota</a></li>
                        <li class="breadcrumb-item active">Anggota Prodi</li>
                    </ol>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Verifikasi Anggota Prodi</h4>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center" style="width: 50px;">
                                                ...
                                                <?php if ($row->file_anggota == '') { ?>

                                                    <button type="button" class="btn-xs btn btn-danger">
                                                        <i class="fa  fa-times"> File Lampiran Kosong</i></button>
                                                <?php

                                                } else {
                                                ?>

                                                    <a href="<?php echo base_url() . './assets/dokumen/' . $row->file_anggota ?>" button type="button" class="btn-xs btn btn-success"><i class="fa  fa-cloud-download"></i> Lihat
                                                        File Lampiran </a>
                                                <?php
                                                } ?>
                                            ...
                                            <td><?= $row->pass ?></td>
                                            <td><?= $row->create_at ?></td>
                                            <td> <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete<?php echo $row->id; ?>"> <i class="fa  fa-trash "></i> Hapus</button></td>
...
?>
    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
            ...
            <div class="modal fade text-left" id="verifikasi<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-info white">
                            <h4 class="modal-title white" id="myModalLabel11">Verifikasi Anggota <?= $row->nama_user ?></h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>

                        <form action="<?php echo base_url() . 'user/AnggotaProdi/update_verifikasi1' ?>" method="post">
                            <div class="modal-body">
                                <div class="col-md-12 m-b-20">


                                    <div class="form-group">
                                        <label for="accountTextarea">Status Verifikasi</label>
                                        ...
                                        <select class="form-control" name="xstatus" required>
                                            ...
                                            <option value="2">Tidak Verifikasi</option>
            ...
            <div class="modal fade text-left" id="status<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'user/AnggotaProdi/update_status1' ?>" method="post">
                            <div class="modal-body">
                                <div class="col-md-12 m-b-20">
            ...
            <div class="modal fade text-left" id="delete<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'user/AnggotaProdi/hapus_anggota1' ?>" method="post">
                            <div class="modal-body">
                                <div class="col-md-12 m-b-20">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p>Apakah Anda yakin mau menghapus Data <b><?php echo $row->nama_anggota; ?>
                                            </b> ini ?</p>
                                    </div>
