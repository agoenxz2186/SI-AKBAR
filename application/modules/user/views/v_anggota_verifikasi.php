    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Verifikasi Anggota</h4>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title"> Verifikasi Anggota Aptikom</h4>
            ...
            <div class="modal fade text-left" id="verifikasi<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'user/Anggota/update_verifikasi' ?>" method="post">
            ...
            <div class="modal fade text-left" id="status<?= $row->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'user/Anggota/update_status1' ?>" method="post">
                            <div class="modal-body">
                                <div class="col-md-12 m-b-20">


                                    <div class="form-group">
                                        <label for="accountTextarea">Verifikasi Anggota</label>
                                        <input type="hidden" name="xkode" value="<?php echo $row->id; ?>" />
            ...
            <div class="modal fade text-left" id="delete<?php echo $row->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo base_url() . 'user/Anggota/hapus_anggota1' ?>" method="post">
                            <div class="modal-body">
                                <div class="col-md-12 m-b-20">
