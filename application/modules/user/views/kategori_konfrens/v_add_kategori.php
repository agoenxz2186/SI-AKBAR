            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?= base_url() ?>user/Konferensi/save_kategori" method="post">
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-10">
                                    ...
                                    <br>
                                    <br>
                                    <input class="form-control slug" type="text" name="xslug" placeholder="masukan slug kategori" required>
                                </div>
                            </div>
